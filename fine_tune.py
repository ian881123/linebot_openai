...
# 檢索 fine-tuning 作業事件
client.fine_tuning.jobs.retrieve("ftjob-trytry123")

# 列出 fine-tuning 作業事件
client.fine_tuning.jobs.list_events(id="trytry123", limit=10)
...
completion2 = client.chat.completions.create(
  model="ft:gpt-3.5-turbo-0125:personal::trytry123",
  messages=[
    {"role": "system", "content": "你扮演一名陸軍軍官學校的客服"},
    {"role": "user", "content": "什麼是陸軍軍官學校學生學則?"}
  ]
