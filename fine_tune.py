...
client.fine_tuning.jobs.create(
  training_file="file-ouRVxQFmBAtCOXdKCT24lCBs", 
...
# 檢索 fine-tuning 作業事件
client.fine_tuning.jobs.retrieve("ftjob-ntgzee19FARkANfIkbbUQbPI")

# 列出 fine-tuning 作業事件
client.fine_tuning.jobs.list_events(fine_tuning_job_id="ftjob-ntgzee19FARkANfIkbbUQbPI", limit=10)
